defmodule Showcase.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.permission == 42
      assert user.plain_password == "some plain_password"
    end
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.permission == 43
      assert user.plain_password == "some updated plain_password"
    end
